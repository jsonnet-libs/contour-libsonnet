---
permalink: /1.10/projectcontour/v1alpha1/extensionService/
---
...
"This field sets the version of the GRPC protocol that Envoy uses to send requests to the extension service. Since Contour always uses the v2 Envoy API, this is currently fixed at \"v2\". However, other protocol options will be available in future."
...
"The policy for load balancing GRPC service requests. Note that the `Cookie` load balancing strategy cannot be used here."
