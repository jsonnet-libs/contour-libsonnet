  ...
  spec: {
    ...
    routes: {
      ...
      services: {
        ...
        validation: {
          '#withCaSecret':: d.fn(help='"Name or namespaced name of the Kubernetes secret used to validate the certificate presented by the backend. The secret must contain key named ca.crt."', args=[d.arg(name='caSecret', type=d.T.string)]),
    ...
    virtualhost: {
      ...
      tls: {
        ...
        clientValidation: {
          ...
          '#withCrlSecret':: d.fn(help='"Name of a Kubernetes opaque secret that contains a concatenated list of PEM encoded CRLs. The secret must contain key named crl.pem. This field will be used to verify that a client certificate has not been revoked. CRLs must be available from all CAs, unless crlOnlyVerifyLeafCert is true. Large CRL lists are not supported since individual secrets are limited to 1MiB in size."', args=[d.arg(name='crlSecret', type=d.T.string)]),
