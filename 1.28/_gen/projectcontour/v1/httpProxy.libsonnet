{
  ...
  spec: {
    '#includes':: d.obj(help='"Includes allow for specific routing configuration to be included from another HTTPProxy,\\npossibly in another namespace."'),
    includes: {
      ...
      conditions: {
        ...
        queryParameter: {
          '#withContains':: d.fn(help='"Contains specifies a substring that must be present in\\nthe query parameter value."', args=[d.arg(name='contains', type=d.T.string)]),
          ...
          '#withName':: d.fn(help='"Name is the name of the query parameter to match against. Name is required.\\nQuery parameter names are case insensitive."', args=[d.arg(name='name', type=d.T.string)]),
          ...
          '#withPresent':: d.fn(help='"Present specifies that condition is true when the named query parameter\\nis present, regardless of its value. Note that setting Present\\nto false does not make the condition true if the named query parameter\\nis absent."', args=[d.arg(name='present', type=d.T.boolean)]),
          withPresent(present): { queryParameter+: { present: present } },
          '#withRegex':: d.fn(help='"Regex specifies a regular expression pattern that must match the query\\nparameter value."', args=[d.arg(name='regex', type=d.T.string)]),
        ...
        '#withExact':: d.fn(help='"Exact defines a exact match for a request.\\nThis field is not allowed in include match conditions."', args=[d.arg(name='exact', type=d.T.string)]),
        ...
        '#withRegex':: d.fn(help='"Regex defines a regex match for a request.\\nThis field is not allowed in include match conditions."', args=[d.arg(name='regex', type=d.T.string)]),
        withRegex(regex): { regex: regex },
      },
      '#withConditions':: d.fn(help='"Conditions are a set of rules that are applied to included HTTPProxies.\\nIn effect, they are added onto the Conditions of included HTTPProxy Route\\nstructs.\\nWhen applied, they are merged using AND, with one exception:\\nThere can be only one Prefix MatchCondition per Conditions slice.\\nMore than one Prefix, or contradictory Conditions, will make the\\ninclude invalid. Exact and Regex match conditions are not allowed\\non includes."', args=[d.arg(name='conditions', type=d.T.array)]),
    ...
    routes: {
      '#authPolicy':: d.obj(help='"AuthPolicy updates the authorization policy that was set\\non the root HTTPProxy object for client requests that\\nmatch this route."'),
      authPolicy: {
      ...
      '#cookieRewritePolicies':: d.obj(help='"The policies for rewriting Set-Cookie header attributes. Note that\\nrewritten cookie names must be unique in this list. Order rewrite\\npolicies are specified in does not matter."'),
      cookieRewritePolicies: {
        '#domainRewrite':: d.obj(help='"DomainRewrite enables rewriting the Set-Cookie Domain element.\\nIf not set, Domain will not be rewritten."'),
        domainRewrite: {
          '#withValue':: d.fn(help='"Value is the value to rewrite the Domain attribute to.\\nFor now this is required."', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { domainRewrite+: { value: value } },
        },
        '#pathRewrite':: d.obj(help='"PathRewrite enables rewriting the Set-Cookie Path element.\\nIf not set, Path will not be rewritten."'),
        pathRewrite: {
          '#withValue':: d.fn(help='"Value is the value to rewrite the Path attribute to.\\nFor now this is required."', args=[d.arg(name='value', type=d.T.string)]),
        ...
        withName(name): { name: name },
        '#withSameSite':: d.fn(help='"SameSite enables rewriting the Set-Cookie SameSite element.\\nIf not set, SameSite attribute will not be rewritten."', args=[d.arg(name='sameSite', type=d.T.string)]),
        withSameSite(sameSite): { sameSite: sameSite },
        '#withSecure':: d.fn(help='"Secure enables rewriting the Set-Cookie Secure element.\\nIf not set, Secure attribute will not be rewritten."', args=[d.arg(name='secure', type=d.T.boolean)]),
      ...
      directResponsePolicy: {
        '#withBody':: d.fn(help='"Body is the content of the response body.\\nIf this setting is omitted, no body is included in the generated response.\\nNote: Body is not recommended to set too long\\notherwise it can have significant resource usage impacts."', args=[d.arg(name='body', type=d.T.string)]),
      ...
      healthCheckPolicy: {
        ...
        '#withExpectedStatuses':: d.fn(help='"The ranges of HTTP response statuses considered healthy. Follow half-open\\nsemantics, i.e. for each range the start is inclusive and the end is exclusive.\\nMust be within the range [100,600). If not specified, only a 200 response status\\nis considered healthy."', args=[d.arg(name='expectedStatuses', type=d.T.array)]),
        ...
        '#withExpectedStatusesMixin':: d.fn(help='"The ranges of HTTP response statuses considered healthy. Follow half-open\\nsemantics, i.e. for each range the start is inclusive and the end is exclusive.\\nMust be within the range [100,600). If not specified, only a 200 response status\\nis considered healthy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='expectedStatuses', type=d.T.array)]),
      ...
      internalRedirectPolicy: {
        '#withAllowCrossSchemeRedirect':: d.fn(help='"AllowCrossSchemeRedirect Allow internal redirect to follow a target URI with a different scheme\\nthan the value of x-forwarded-proto.\\nSafeOnly allows same scheme redirect and safe cross scheme redirect, which means if the downstream\\nscheme is HTTPS, both HTTPS and HTTP redirect targets are allowed, but if the downstream scheme\\nis HTTP, only HTTP redirect targets are allowed."', args=[d.arg(name='allowCrossSchemeRedirect', type=d.T.string)]),
        ...
        '#withDenyRepeatedRouteRedirect':: d.fn(help='"If DenyRepeatedRouteRedirect is true, rejects redirect targets that are pointing to a route that has\\nbeen followed by a previous redirect from the current route."', args=[d.arg(name='denyRepeatedRouteRedirect', type=d.T.boolean)]),
        ...
        '#withMaxInternalRedirects':: d.fn(help='"MaxInternalRedirects An internal redirect is not handled, unless the number of previous internal\\nredirects that a downstream request has encountered is lower than this value."', args=[d.arg(name='maxInternalRedirects', type=d.T.integer)]),
        withMaxInternalRedirects(maxInternalRedirects): { internalRedirectPolicy+: { maxInternalRedirects: maxInternalRedirects } },
        '#withRedirectResponseCodes':: d.fn(help='"RedirectResponseCodes If unspecified, only 302 will be treated as internal redirect.\\nOnly 301, 302, 303, 307 and 308 are valid values."', args=[d.arg(name='redirectResponseCodes', type=d.T.array)]),
      ...
      '#ipAllowPolicy':: d.obj(help='"IPAllowFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be allowed. All other requests will be denied.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."'),
      ipAllowPolicy: {
        '#withCidr':: d.fn(help='"CIDR is a CIDR block of ipv4 or ipv6 addresses to filter on. This can also be\\na bare IP address (without a mask) to filter on exactly one address."', args=[d.arg(name='cidr', type=d.T.string)]),
        withCidr(cidr): { cidr: cidr },
        '#withSource':: d.fn(help='"Source indicates how to determine the ip address to filter on, and can be\\none of two values:\\n - `Remote` filters on the ip address of the client, accounting for PROXY and\\n   X-Forwarded-For as needed.\\n - `Peer` filters on the ip of the network request, ignoring PROXY and\\n   X-Forwarded-For."', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { source: source },
      },
      '#ipDenyPolicy':: d.obj(help='"IPDenyFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be denied. All other requests will be allowed.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."'),
      ipDenyPolicy: {
        '#withCidr':: d.fn(help='"CIDR is a CIDR block of ipv4 or ipv6 addresses to filter on. This can also be\\na bare IP address (without a mask) to filter on exactly one address."', args=[d.arg(name='cidr', type=d.T.string)]),
        withCidr(cidr): { cidr: cidr },
        '#withSource':: d.fn(help='"Source indicates how to determine the ip address to filter on, and can be\\none of two values:\\n - `Remote` filters on the ip address of the client, accounting for PROXY and\\n   X-Forwarded-For as needed.\\n - `Peer` filters on the ip of the network request, ignoring PROXY and\\n   X-Forwarded-For."', args=[d.arg(name='source', type=d.T.string)]),
      ...
      loadBalancerPolicy: {
        '#requestHashPolicies':: d.obj(help='"RequestHashPolicies contains a list of hash policies to apply when the\\n`RequestHash` load balancing strategy is chosen. If an element of the\\nsupplied list of hash policies is invalid, it will be ignored. If the\\nlist of hash policies is empty after validation, the load balancing\\nstrategy will fall back to the default `RoundRobin`."'),
        requestHashPolicies: {
          '#headerHashOptions':: d.obj(help='"HeaderHashOptions should be set when request header hash based load\\nbalancing is desired. It must be the only hash option field set,\\notherwise this request hash policy object will be ignored."'),
          headerHashOptions: {
            '#withHeaderName':: d.fn(help='"HeaderName is the name of the HTTP request header that will be used to\\ncalculate the hash key. If the header specified is not present on a\\nrequest, no hash will be produced."', args=[d.arg(name='headerName', type=d.T.string)]),
            withHeaderName(headerName): { headerHashOptions+: { headerName: headerName } },
          },
          '#queryParameterHashOptions':: d.obj(help='"QueryParameterHashOptions should be set when request query parameter hash based load\\nbalancing is desired. It must be the only hash option field set,\\notherwise this request hash policy object will be ignored."'),
          queryParameterHashOptions: {
            '#withParameterName':: d.fn(help='"ParameterName is the name of the HTTP request query parameter that will be used to\\ncalculate the hash key. If the query parameter specified is not present on a\\nrequest, no hash will be produced."', args=[d.arg(name='parameterName', type=d.T.string)]),
            withParameterName(parameterName): { queryParameterHashOptions+: { parameterName: parameterName } },
          },
          '#withHashSourceIP':: d.fn(help='"HashSourceIP should be set to true when request source IP hash based\\nload balancing is desired. It must be the only hash option field set,\\notherwise this request hash policy object will be ignored."', args=[d.arg(name='hashSourceIP', type=d.T.boolean)]),
          withHashSourceIP(hashSourceIP): { hashSourceIP: hashSourceIP },
          '#withTerminal':: d.fn(help='"Terminal is a flag that allows for short-circuiting computing of a hash\\nfor a given request. If set to true, and the request attribute specified\\nin the attribute hash options is present, no further hash policies will\\nbe used to calculate a hash for the request."', args=[d.arg(name='terminal', type=d.T.boolean)]),
          withTerminal(terminal): { terminal: terminal },
        },
        '#withRequestHashPolicies':: d.fn(help='"RequestHashPolicies contains a list of hash policies to apply when the\\n`RequestHash` load balancing strategy is chosen. If an element of the\\nsupplied list of hash policies is invalid, it will be ignored. If the\\nlist of hash policies is empty after validation, the load balancing\\nstrategy will fall back to the default `RoundRobin`."', args=[d.arg(name='requestHashPolicies', type=d.T.array)]),
        ...
        '#withRequestHashPoliciesMixin':: d.fn(help='"RequestHashPolicies contains a list of hash policies to apply when the\\n`RequestHash` load balancing strategy is chosen. If an element of the\\nsupplied list of hash policies is invalid, it will be ignored. If the\\nlist of hash policies is empty after validation, the load balancing\\nstrategy will fall back to the default `RoundRobin`."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requestHashPolicies', type=d.T.array)]),
      ...
      rateLimitPolicy: {
        ...
        '#local':: d.obj(help='"Local defines local rate limiting parameters, i.e. parameters\\nfor rate limiting that occurs within each Envoy pod as requests\\nare handled."'),
        'local': {
          '#responseHeadersToAdd':: d.obj(help='"ResponseHeadersToAdd is an optional list of response headers to\\nset when a request is rate-limited."'),
          ...
          '#withBurst':: d.fn(help='"Burst defines the number of requests above the requests per\\nunit that should be allowed within a short period of time."', args=[d.arg(name='burst', type=d.T.integer)]),
          withBurst(burst): { rateLimitPolicy+: { 'local'+: { burst: burst } } },
          '#withRequests':: d.fn(help='"Requests defines how many requests per unit of time should\\nbe allowed before rate limiting occurs."', args=[d.arg(name='requests', type=d.T.integer)]),
          withRequests(requests): { rateLimitPolicy+: { 'local'+: { requests: requests } } },
          '#withResponseHeadersToAdd':: d.fn(help='"ResponseHeadersToAdd is an optional list of response headers to\\nset when a request is rate-limited."', args=[d.arg(name='responseHeadersToAdd', type=d.T.array)]),
          ...
          '#withResponseStatusCode':: d.fn(help='"ResponseStatusCode is the HTTP status code to use for responses\\nto rate-limited requests. Codes must be in the 400-599 range\\n(inclusive). If not specified, the Envoy default of 429 (Too\\nMany Requests) is used."', args=[d.arg(name='responseStatusCode', type=d.T.integer)]),
          withResponseStatusCode(responseStatusCode): { rateLimitPolicy+: { 'local'+: { responseStatusCode: responseStatusCode } } },
          '#withUnit':: d.fn(help='"Unit defines the period of time within which requests\\nover the limit will be rate limited. Valid values are\\n\\"second\\", \\"minute\\" and \\"hour\\"."', args=[d.arg(name='unit', type=d.T.string)]),
      ...
      requestHeadersPolicy: {
        ...
        '#withSet':: d.fn(help='"Set specifies a list of HTTP header values that will be set in the HTTP header.\\nIf the header does not exist it will be added, otherwise it will be overwritten with the new value."', args=[d.arg(name='set', type=d.T.array)]),
        withSet(set): { requestHeadersPolicy+: { set: if std.isArray(v=set) then set else [set] } },
        '#withSetMixin':: d.fn(help='"Set specifies a list of HTTP header values that will be set in the HTTP header.\\nIf the header does not exist it will be added, otherwise it will be overwritten with the new value."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='set', type=d.T.array)]),
      ...
      '#responseHeadersPolicy':: d.obj(help="\"The policy for managing response headers during proxying.\\nRewriting the 'Host' header is not supported.\""),
      ...
      retryPolicy: {
        '#withCount':: d.fn(help='"NumRetries is maximum allowed number of retries.\\nIf set to -1, then retries are disabled.\\nIf set to 0 or not supplied, the value is set\\nto the Envoy default of 1."', args=[d.arg(name='count', type=d.T.integer)]),
        withCount(count): { retryPolicy+: { count: count } },
        '#withPerTryTimeout':: d.fn(help='"PerTryTimeout specifies the timeout per retry attempt.\\nIgnored if NumRetries is not supplied."', args=[d.arg(name='perTryTimeout', type=d.T.string)]),
      ...
      services: {
        ...
        validation: {
          '#withCaSecret':: d.fn(help='"Name or namespaced name of the Kubernetes secret used to validate the certificate presented by the backend.\\nThe secret must contain key named ca.crt.\\nThe name can be optionally prefixed with namespace \\"namespace/name\\".\\nWhen cross-namespace reference is used, TLSCertificateDelegation resource must exist in the namespace to grant access to the secret.\\nMax length should be the actual max possible length of a namespaced name (63 + 253 + 1 = 317)"', args=[d.arg(name='caSecret', type=d.T.string)]),
          withCaSecret(caSecret): { validation+: { caSecret: caSecret } },
          '#withSubjectName':: d.fn(help="\"Key which is expected to be present in the 'subjectAltName' of the presented certificate.\\nDeprecated: migrate to using the plural field subjectNames.\"", args=[d.arg(name='subjectName', type=d.T.string)]),
          withSubjectName(subjectName): { validation+: { subjectName: subjectName } },
          '#withSubjectNames':: d.fn(help="\"List of keys, of which at least one is expected to be present in the 'subjectAltName of the\\npresented certificate.\"", args=[d.arg(name='subjectNames', type=d.T.array)]),
          withSubjectNames(subjectNames): { validation+: { subjectNames: if std.isArray(v=subjectNames) then subjectNames else [subjectNames] } },
          '#withSubjectNamesMixin':: d.fn(help="\"List of keys, of which at least one is expected to be present in the 'subjectAltName of the\\npresented certificate.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='subjectNames', type=d.T.array)]),
          withSubjectNamesMixin(subjectNames): { validation+: { subjectNames+: if std.isArray(v=subjectNames) then subjectNames else [subjectNames] } },
        },
        ...
        '#withHealthPort':: d.fn(help='"HealthPort is the port for this service healthcheck.\\nIf not specified, Port is used for service healthchecks."', args=[d.arg(name='healthPort', type=d.T.integer)]),
        withHealthPort(healthPort): { healthPort: healthPort },
        '#withMirror':: d.fn(help='"If Mirror is true the Service will receive a read only mirror of the traffic for this route.\\nIf Mirror is true, then fractional mirroring can be enabled by optionally setting the Weight\\nfield. Legal values for Weight are 1-100. Omitting the Weight field will result in 100% mirroring.\\nNOTE: Setting Weight explicitly to 0 will unexpectedly result in 100% traffic mirroring. This\\noccurs since we cannot distinguish omitted fields from those explicitly set to their default\\nvalues"', args=[d.arg(name='mirror', type=d.T.boolean)]),
        withMirror(mirror): { mirror: mirror },
        '#withName':: d.fn(help='"Name is the name of Kubernetes service to proxy traffic.\\nNames defined here will be used to look up corresponding endpoints which contain the ips to route."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        ...
        '#withProtocol':: d.fn(help='"Protocol may be used to specify (or override) the protocol used to reach this Service.\\nValues may be tls, h2, h2c. If omitted, protocol-selection falls back on Service annotations."', args=[d.arg(name='protocol', type=d.T.string)]),
      ...
      timeoutPolicy: {
        '#withIdle':: d.fn(help='"Timeout for how long the proxy should wait while there is no activity during single request/response (for HTTP/1.1) or stream (for HTTP/2).\\nTimeout will not trigger while HTTP/1.1 connection is idle between two consecutive requests.\\nIf not specified, there is no per-route idle timeout, though a connection manager-wide\\nstream_idle_timeout default of 5m still applies."', args=[d.arg(name='idle', type=d.T.string)]),
        withIdle(idle): { timeoutPolicy+: { idle: idle } },
        '#withIdleConnection':: d.fn(help="\"Timeout for how long connection from the proxy to the upstream service is kept when there are no active requests.\\nIf not supplied, Envoy's default value of 1h applies.\"", args=[d.arg(name='idleConnection', type=d.T.string)]),
        withIdleConnection(idleConnection): { timeoutPolicy+: { idleConnection: idleConnection } },
        '#withResponse':: d.fn(help="\"Timeout for receiving a response from the server after processing a request from client.\\nIf not supplied, Envoy's default value of 15s applies.\"", args=[d.arg(name='response', type=d.T.string)]),
        withResponse(response): { timeoutPolicy+: { response: response } },
      },
      '#withConditions':: d.fn(help='"Conditions are a set of rules that are applied to a Route.\\nWhen applied, they are merged using AND, with one exception:\\nThere can be only one Prefix, Exact or Regex MatchCondition\\nper Conditions slice. More than one of these condition types,\\nor contradictory Conditions, will make the route invalid."', args=[d.arg(name='conditions', type=d.T.array)]),
      withConditions(conditions): { conditions: if std.isArray(v=conditions) then conditions else [conditions] },
      '#withConditionsMixin':: d.fn(help='"Conditions are a set of rules that are applied to a Route.\\nWhen applied, they are merged using AND, with one exception:\\nThere can be only one Prefix, Exact or Regex MatchCondition\\nper Conditions slice. More than one of these condition types,\\nor contradictory Conditions, will make the route invalid."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='conditions', type=d.T.array)]),
      withConditionsMixin(conditions): { conditions+: if std.isArray(v=conditions) then conditions else [conditions] },
      '#withCookieRewritePolicies':: d.fn(help='"The policies for rewriting Set-Cookie header attributes. Note that\\nrewritten cookie names must be unique in this list. Order rewrite\\npolicies are specified in does not matter."', args=[d.arg(name='cookieRewritePolicies', type=d.T.array)]),
      withCookieRewritePolicies(cookieRewritePolicies): { cookieRewritePolicies: if std.isArray(v=cookieRewritePolicies) then cookieRewritePolicies else [cookieRewritePolicies] },
      '#withCookieRewritePoliciesMixin':: d.fn(help='"The policies for rewriting Set-Cookie header attributes. Note that\\nrewritten cookie names must be unique in this list. Order rewrite\\npolicies are specified in does not matter."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cookieRewritePolicies', type=d.T.array)]),
      withCookieRewritePoliciesMixin(cookieRewritePolicies): { cookieRewritePolicies+: if std.isArray(v=cookieRewritePolicies) then cookieRewritePolicies else [cookieRewritePolicies] },
      ...
      '#withIpAllowPolicy':: d.fn(help='"IPAllowFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be allowed. All other requests will be denied.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."', args=[d.arg(name='ipAllowPolicy', type=d.T.array)]),
      withIpAllowPolicy(ipAllowPolicy): { ipAllowPolicy: if std.isArray(v=ipAllowPolicy) then ipAllowPolicy else [ipAllowPolicy] },
      '#withIpAllowPolicyMixin':: d.fn(help='"IPAllowFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be allowed. All other requests will be denied.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAllowPolicy', type=d.T.array)]),
      withIpAllowPolicyMixin(ipAllowPolicy): { ipAllowPolicy+: if std.isArray(v=ipAllowPolicy) then ipAllowPolicy else [ipAllowPolicy] },
      '#withIpDenyPolicy':: d.fn(help='"IPDenyFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be denied. All other requests will be allowed.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."', args=[d.arg(name='ipDenyPolicy', type=d.T.array)]),
      withIpDenyPolicy(ipDenyPolicy): { ipDenyPolicy: if std.isArray(v=ipDenyPolicy) then ipDenyPolicy else [ipDenyPolicy] },
      '#withIpDenyPolicyMixin':: d.fn(help='"IPDenyFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be denied. All other requests will be allowed.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here override any rules set on the root HTTPProxy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipDenyPolicy', type=d.T.array)]),
      withIpDenyPolicyMixin(ipDenyPolicy): { ipDenyPolicy+: if std.isArray(v=ipDenyPolicy) then ipDenyPolicy else [ipDenyPolicy] },
      '#withPermitInsecure':: d.fn(help='"Allow this path to respond to insecure requests over HTTP which are normally\\nnot permitted when a `virtualhost.tls` block is present."', args=[d.arg(name='permitInsecure', type=d.T.boolean)]),
    ...
    tcpproxy: {
      ...
      '#loadBalancerPolicy':: d.obj(help='"The load balancing policy for the backend services. Note that the\\n`Cookie` and `RequestHash` load balancing strategies cannot be used\\nhere."'),
      loadBalancerPolicy: {
        '#requestHashPolicies':: d.obj(help='"RequestHashPolicies contains a list of hash policies to apply when the\\n`RequestHash` load balancing strategy is chosen. If an element of the\\nsupplied list of hash policies is invalid, it will be ignored. If the\\nlist of hash policies is empty after validation, the load balancing\\nstrategy will fall back to the default `RoundRobin`."'),
        requestHashPolicies: {
          '#headerHashOptions':: d.obj(help='"HeaderHashOptions should be set when request header hash based load\\nbalancing is desired. It must be the only hash option field set,\\notherwise this request hash policy object will be ignored."'),
    ...
    virtualhost: {
      ...
      corsPolicy: {
        ...
        '#withAllowPrivateNetwork':: d.fn(help='"AllowPrivateNetwork specifies whether to allow private network requests.\\nSee https://developer.chrome.com/blog/private-network-access-preflight."', args=[d.arg(name='allowPrivateNetwork', type=d.T.boolean)]),
      ...
      jwtProviders: {
        ...
        remoteJWKS: {
          ...
          validation: {
            ...
            '#withSubjectNames':: d.fn(help="\"List of keys, of which at least one is expected to be present in the 'subjectAltName of the\\npresented certificate.\"", args=[d.arg(name='subjectNames', type=d.T.array)]),
            withSubjectNames(subjectNames): { remoteJWKS+: { validation+: { subjectNames: if std.isArray(v=subjectNames) then subjectNames else [subjectNames] } } },
            '#withSubjectNamesMixin':: d.fn(help="\"List of keys, of which at least one is expected to be present in the 'subjectAltName of the\\npresented certificate.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='subjectNames', type=d.T.array)]),
            withSubjectNamesMixin(subjectNames): { remoteJWKS+: { validation+: { subjectNames+: if std.isArray(v=subjectNames) then subjectNames else [subjectNames] } } },
          },
          '#withCacheDuration':: d.fn(help="\"How long to cache the JWKS locally. If not specified,\\nEnvoy's default of 5m applies.\"", args=[d.arg(name='cacheDuration', type=d.T.string)]),
          withCacheDuration(cacheDuration): { remoteJWKS+: { cacheDuration: cacheDuration } },
          '#withDnsLookupFamily':: d.fn(help='"The DNS IP address resolution policy for the JWKS URI.\\nWhen configured as \\"v4\\", the DNS resolver will only perform a lookup\\nfor addresses in the IPv4 family. If \\"v6\\" is configured, the DNS resolver\\nwill only perform a lookup for addresses in the IPv6 family.\\nIf \\"all\\" is configured, the DNS resolver\\nwill perform a lookup for addresses in both the IPv4 and IPv6 family.\\nIf \\"auto\\" is configured, the DNS resolver will first perform a lookup\\nfor addresses in the IPv6 family and fallback to a lookup for addresses\\nin the IPv4 family. If not specified, the Contour-wide setting defined\\nin the config file or ContourConfiguration applies (defaults to \\"auto\\").\\nSee https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/cluster/v3/cluster.proto.html#envoy-v3-api-enum-config-cluster-v3-cluster-dnslookupfamily\\nfor more information."', args=[d.arg(name='dnsLookupFamily', type=d.T.string)]),
          withDnsLookupFamily(dnsLookupFamily): { remoteJWKS+: { dnsLookupFamily: dnsLookupFamily } },
          '#withTimeout':: d.fn(help='"How long to wait for a response from the URI.\\nIf not specified, a default of 1s applies."', args=[d.arg(name='timeout', type=d.T.string)]),
        ...
        '#withAudiences':: d.fn(help='"Audiences that JWTs are allowed to have in the \\"aud\\" field.\\nIf not provided, JWT audiences are not checked."', args=[d.arg(name='audiences', type=d.T.array)]),
        withAudiences(audiences): { audiences: if std.isArray(v=audiences) then audiences else [audiences] },
        '#withAudiencesMixin':: d.fn(help='"Audiences that JWTs are allowed to have in the \\"aud\\" field.\\nIf not provided, JWT audiences are not checked."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='audiences', type=d.T.array)]),
        withAudiencesMixin(audiences): { audiences+: if std.isArray(v=audiences) then audiences else [audiences] },
        '#withDefault':: d.fn(help='"Whether the provider should apply to all\\nroutes in the HTTPProxy/its includes by\\ndefault. At most one provider can be marked\\nas the default. If no provider is marked\\nas the default, individual routes must explicitly\\nidentify the provider they require."', args=[d.arg(name='default', type=d.T.boolean)]),
        withDefault(default): { default: default },
        '#withForwardJWT':: d.fn(help='"Whether the JWT should be forwarded to the backend\\nservice after successful verification. By default,\\nthe JWT is not forwarded."', args=[d.arg(name='forwardJWT', type=d.T.boolean)]),
        withForwardJWT(forwardJWT): { forwardJWT: forwardJWT },
        '#withIssuer':: d.fn(help='"Issuer that JWTs are required to have in the \\"iss\\" field.\\nIf not provided, JWT issuers are not checked."', args=[d.arg(name='issuer', type=d.T.string)]),
      ...
      tls: {
        ...
        clientValidation: {
          ...
          '#withCaSecret':: d.fn(help='"Name of a Kubernetes secret that contains a CA certificate bundle.\\nThe secret must contain key named ca.crt.\\nThe client certificate must validate against the certificates in the bundle.\\nIf specified and SkipClientCertValidation is true, client certificates will\\nbe required on requests.\\nThe name can be optionally prefixed with namespace \\"namespace/name\\".\\nWhen cross-namespace reference is used, TLSCertificateDelegation resource must exist in the namespace to grant access to the secret."', args=[d.arg(name='caSecret', type=d.T.string)]),
          withCaSecret(caSecret): { spec+: { virtualhost+: { tls+: { clientValidation+: { caSecret: caSecret } } } } },
          '#withCrlOnlyVerifyLeafCert':: d.fn(help='"If this option is set to true, only the certificate at the end of the\\ncertificate chain will be subject to validation by CRL."', args=[d.arg(name='crlOnlyVerifyLeafCert', type=d.T.boolean)]),
        ...
        '#withEnableFallbackCertificate':: d.fn(help="\"EnableFallbackCertificate defines if the vhost should allow a default certificate to\\nbe applied which handles all requests which don't match the SNI defined in this vhost.\"", args=[d.arg(name='enableFallbackCertificate', type=d.T.boolean)]),
      ...
      '#withIpDenyPolicy':: d.fn(help='"IPDenyFilterPolicy is a list of ipv4/6 filter rules for which matching\\nrequests should be denied. All other requests will be allowed.\\nOnly one of IPAllowFilterPolicy and IPDenyFilterPolicy can be defined.\\nThe rules defined here may be overridden in a Route."', args=[d.arg(name='ipDenyPolicy', type=d.T.array)]),
    ...
    '#withIncludes':: d.fn(help='"Includes allow for specific routing configuration to be included from another HTTPProxy,\\npossibly in another namespace."', args=[d.arg(name='includes', type=d.T.array)]),
    withIncludes(includes): { spec+: { includes: if std.isArray(v=includes) then includes else [includes] } },
    '#withIncludesMixin':: d.fn(help='"Includes allow for specific routing configuration to be included from another HTTPProxy,\\npossibly in another namespace."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='includes', type=d.T.array)]),
    withIncludesMixin(includes): { spec+: { includes+: if std.isArray(v=includes) then includes else [includes] } },
    '#withIngressClassName':: d.fn(help='"IngressClassName optionally specifies the ingress class to use for this\\nHTTPProxy. This replaces the deprecated `kubernetes.io/ingress.class`\\nannotation. For backwards compatibility, when that annotation is set, it\\nis given precedence over this field."', args=[d.arg(name='ingressClassName', type=d.T.string)]),
