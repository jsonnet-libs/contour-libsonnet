{
  ...
  spec: {
    ...
    contour: {
      ...
      '#withPodAnnotations':: d.fn(help='"PodAnnotations defines annotations to add to the Contour pods. the annotations for Prometheus will be appended or overwritten with predefined value."', args=[d.arg(name='podAnnotations', type=d.T.object)]),
      withPodAnnotations(podAnnotations): { spec+: { contour+: { podAnnotations: podAnnotations } } },
      '#withPodAnnotationsMixin':: d.fn(help='"PodAnnotations defines annotations to add to the Contour pods. the annotations for Prometheus will be appended or overwritten with predefined value."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podAnnotations', type=d.T.object)]),
    ...
    envoy: {
      ...
      networkPublishing: {
        ...
        '#withIpFamilyPolicy':: d.fn(help='"IPFamilyPolicy represents the dual-stack-ness requested or required by this Service. If there is no value provided, then this field will be set to SingleStack. Services can be \\"SingleStack\\" (a single IP family), \\"PreferDualStack\\" (two IP families on dual-stack configured clusters or a single IP family on single-stack clusters), or \\"RequireDualStack\\" (two IP families on dual-stack configured clusters, otherwise fail)."', args=[d.arg(name='ipFamilyPolicy', type=d.T.string)]),
      ...
      '#withBaseID':: d.fn(help='"The base ID to use when allocating shared memory regions. if Envoy needs to be run multiple times on the same machine, each running Envoy will need a unique base ID so that the shared memory regions do not conflict. defaults to 0."', args=[d.arg(name='baseID', type=d.T.integer)]),
